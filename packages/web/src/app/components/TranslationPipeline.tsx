        ...
        <div className="w-full max-w-4xl mx-auto">
            <div className="relative">
                ...
                <div className="flex items-center justify-between gap-2 md:gap-4">
                    ...
                    >
                        <div className={`rounded-2xl p-4 md:p-6 border-2 transition-all duration-300 ${stage === 'input'
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                    >
                        <div className={`rounded-2xl p-4 md:p-6 border-2 transition-all duration-300 ${stage === 'output'
